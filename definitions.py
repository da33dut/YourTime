"""YourTime – application-wide constants: layout, colours, timings, i18n, config defaults."""
...
# ---------------------------------------------------------------------------
# Sentinels / priorities
# ---------------------------------------------------------------------------
UNLIMITED: int = -1
MSG_PRIO: dict[str, int] = {"red": 0, "orange": 1, "blue": 2, "green": 3}

# ---------------------------------------------------------------------------
# Windows autostart registry paths
# ---------------------------------------------------------------------------
...
W_STATUSBAR_DT = 20; W_STATUSBAR_REM = 14

# ---------------------------------------------------------------------------
# Padding (pixels / Tkinter units)
# ---------------------------------------------------------------------------
BTN_PAD = 4; PAD_OUTER = 8; PAD_INNER = 5
PAD_ROW = 1; PAD_BTN   = 3

# ---------------------------------------------------------------------------
# Per-day limit bounds (minutes)
# ---------------------------------------------------------------------------
